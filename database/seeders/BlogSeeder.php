    ...
    public function run(): void
    {
        DB::table('blogs')->insert([
            [
                ...
                'description' => '<p>Bali, with its lush landscapes and hidden treasures, unfolds yet another gem for those seeking nature\'s tranquility - Nungnung Waterfall. This breathtaking cascade, tucked away in the heart of Bali, promises a journey that combines adventure, serenity, and the raw beauty of the island\'s hinterlands.</p><p>Off the Beaten Path:<br/> Nungnung Waterfall remains a relatively untouched paradise, offering an escape from the bustling tourist hotspots. Located in the Petang Village, this waterfall provides an opportunity to venture off the beaten path and immerse yourself in the authentic beauty of Bali.</p><p>The Journey Begins:<br/>
                The trek to Nungnung Waterfall is an adventure in itself. A winding path through lush greenery and traditional villages leads the way. The journey involves descending a series of steep steps, providing glimpses of the surrounding rice terraces and native flora.</p><p>A Majestic Arrival:<br/>As you approach the waterfall, the distant roar of cascading water grows louder. Suddenly, the dense foliage opens up to reveal Nungnung in all its glory - a majestic 50-meter tall waterfall surrounded by a natural amphitheater of rocks and tropical vegetation.</p><p>Serenity Amidst Nature:<br/>
